...
import AppointmentDetailForm, { Appointment } from '../AppointmentDetailForm'
...
const NewAppointment = () => {
  ...
  const [newAppointmentMutateError, _setError] = useState<AppointmentError>({} as AppointmentError)
  ...
  const {
    ...
    validator: _validateNewAppointment,
